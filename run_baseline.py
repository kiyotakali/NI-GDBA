...
def main(args):
    ...
    average_all_clean_acc_list, average_local_attack_success_rate_acc_list, average_local_clean_acc_list, final_attack_success_rate_list_list = [], [], [], []
    results_table = []
    metric_list = []
    ...
    for i in range(len(seeds)):
        ...
        results_table.append([average_all_clean_acc, average_local_attack_success_rate_acc, average_local_clean_acc, average_local_unchanged_acc,average_transfer_attack_success_rate, final_attack_success_rate])
        logger.log({"average_all_clean_acc": average_all_clean_acc,
                    ...
                    "final_attack_success_rate_list":final_attack_success_rate})
    ...
    columns = ["average_all_clean_acc", "average_local_attack_success_rate_acc", "average_local_clean_acc", "average_local_unchanged_acc","average_transfer_attack_success_rate","final_attack_success_rate"]
    ...
    header = ['dataset', 'model', "mean_average_all_clean_acc",
              ...
              "mean_final_attack_success_rate","std_final_attack_success_rate"]
    ...
    metric_list.append(mean_final_attack_success_rate)
    metric_list.append(std_final_attack_success_rate)
